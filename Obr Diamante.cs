...
//UltrasonicSensor ultra_T = Bot.GetComponent<UltrasonicSensor>("ultraBack");
...
/*distanciaesquerda = Bot.GetComponent<UltrasonicSensor>("ultra_E").Analog.ToString();
double distanciaL = ultra_E.Analog;*/
